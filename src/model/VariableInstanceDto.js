 ...
 * @version 7.20.0
 */
export class VariableInstanceDto {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new VariableInstanceDto();
 ...
 */
VariableInstanceDto.prototype.value = undefined;

/**
 * The value type of the variable.
 * @member {String} type
 */
VariableInstanceDto.prototype.type = undefined;
 ...
 */
VariableInstanceDto.prototype.valueInfo = undefined;
