 ...
 * @version 7.20.0
 */
export class ProcessInstanceModificationInstructionDto {
  /**
...
/**
 * Can be used with instructions of type `cancel`. Specifies the activity instance to cancel. Valid values are the activity instance IDs supplied by the [Get Activity Instance request](https://docs.camunda.org/manual/develop/reference/rest/process-instance/get-activity-instances/).
 * @member {String} activityInstanceId
 */
ProcessInstanceModificationInstructionDto.prototype.activityInstanceId = undefined;

/**
 * Can be used with instructions of type `cancel`. Specifies the transition instance to cancel. Valid values are the transition instance IDs supplied by the [Get Activity Instance request](https://docs.camunda.org/manual/develop/reference/rest/process-instance/get-activity-instances/).
