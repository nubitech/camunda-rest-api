...
/**
 * The HistoricBatchDto model module.
 * @module model/HistoricBatchDto
 * @version 7.20.0
 */
export class HistoricBatchDto {
  /**
   * Constructs a new <code>HistoricBatchDto</code>.
   * @alias module:model/HistoricBatchDto
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>HistoricBatchDto</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HistoricBatchDto} obj Optional instance to populate.
   * @return {module:model/HistoricBatchDto} The populated <code>HistoricBatchDto</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new HistoricBatchDto();
 ...
 * @member {String} id
 */
HistoricBatchDto.prototype.id = undefined;
 ...
 * @member {String} type
 */
HistoricBatchDto.prototype.type = undefined;

/**
 *  The total jobs of a batch is the number of batch execution jobs required to complete the batch. 
 * @member {Number} totalJobs
 */
HistoricBatchDto.prototype.totalJobs = undefined;
 ...
 */
HistoricBatchDto.prototype.batchJobsPerSeed = undefined;
 ...
 */
HistoricBatchDto.prototype.invocationsPerBatchJob = undefined;

/**
 * The job definition id for the seed jobs of this batch.
 * @member {String} seedJobDefinitionId
 */
HistoricBatchDto.prototype.seedJobDefinitionId = undefined;

/**
 * The job definition id for the monitor jobs of this batch.
 * @member {String} monitorJobDefinitionId
 */
HistoricBatchDto.prototype.monitorJobDefinitionId = undefined;

/**
 * The job definition id for the batch execution jobs of this batch.
 * @member {String} batchJobDefinitionId
 */
HistoricBatchDto.prototype.batchJobDefinitionId = undefined;

/**
 * The tenant id of the batch.
 * @member {String} tenantId
 */
HistoricBatchDto.prototype.tenantId = undefined;

/**
 * The batch creator's user id.
 * @member {String} createUserId
 */
HistoricBatchDto.prototype.createUserId = undefined;
 ...
 */
HistoricBatchDto.prototype.startTime = undefined;
 ...
 */
HistoricBatchDto.prototype.executionStartTime = undefined;

/**
 * The time the batch ended. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further information, please see the [documentation](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/)
 * @member {Date} endTime
 */
HistoricBatchDto.prototype.endTime = undefined;

/**
 * The time after which the historic batch should be removed by the History Cleanup job. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further information, please see the [documentation](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/)
 * @member {Date} removalTime
 */
HistoricBatchDto.prototype.removalTime = undefined;
