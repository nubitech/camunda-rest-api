 ...
 * @version 7.20.0
 */
export class HistoricProcessInstanceDto {
  /**
...
/**
 * The time the instance was started. Default [format](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
 * @member {Date} startTime
 */
HistoricProcessInstanceDto.prototype.startTime = undefined;

/**
 * The time the instance ended. Default [format](https://docs.camunda.org/manual/develop/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
 * @member {Date} endTime
 */
