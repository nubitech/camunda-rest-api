# CamundaRestApi.ProcessDefinitionApi
...
let apiInstance = new CamundaRestApi.ProcessDefinitionApi();
...
> &#x27;Blob&#x27; getDeployedStartFormByKey(key)
...
> &#x27;Blob&#x27; getDeployedStartFormByKeyAndTenantId(key, tenantId)
...
> &#x27;Blob&#x27; getProcessDefinitionDiagram(id)
...
> &#x27;Blob&#x27; getProcessDefinitionDiagramByKey(key)
...
> &#x27;Blob&#x27; getProcessDefinitionDiagramByKeyAndTenantId(key, tenantId)
...
> &#x27;Blob&#x27; getRenderedStartFormByKey(key)
...
> &#x27;Blob&#x27; getRenderedStartFormByKeyAndTenantId(key, tenantId)
...
> [CalledProcessDefinitionDto] getStaticCalledProcessDefinitions(id)
...
apiInstance.getStaticCalledProcessDefinitions(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = { 
  'body': new CamundaRestApi.RestartProcessInstanceDto() // RestartProcessInstanceDto | 
};
 ...
 **body** | [**RestartProcessInstanceDto**](RestartProcessInstanceDto.md)|  | [optional] 
...
let id = "id_example"; // String | The id of the process definition to be retrieved.
let opts = { 
  'body': new CamundaRestApi.StartProcessInstanceDto() // StartProcessInstanceDto | 
};
...
------------- | ------------- | ------------- | -------------
 **id** | **String**| The id of the process definition to be retrieved. | 
 **body** | [**StartProcessInstanceDto**](StartProcessInstanceDto.md)|  | [optional] 
...
let opts = { 
  'body': new CamundaRestApi.StartProcessInstanceFormDto() // StartProcessInstanceFormDto | 
};
 ...
 **body** | [**StartProcessInstanceFormDto**](StartProcessInstanceFormDto.md)|  | [optional] 
...
let apiInstance = new CamundaRestApi.ProcessDefinitionApi();
let opts = { 
  'body': new CamundaRestApi.ProcessDefinitionSuspensionStateDto() // ProcessDefinitionSuspensionStateDto | **Note**: Unallowed property is `processDefinitionId`.
};
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**ProcessDefinitionSuspensionStateDto**](ProcessDefinitionSuspensionStateDto.md)| **Note**: Unallowed property is &#x60;processDefinitionId&#x60;. | [optional] 
...
let opts = { 
  'body': new CamundaRestApi.ProcessDefinitionSuspensionStateDto() // ProcessDefinitionSuspensionStateDto | **Note**: Unallowed properties are `processDefinitionId` and `processDefinitionKey`.
};
 ...
 **body** | [**ProcessDefinitionSuspensionStateDto**](ProcessDefinitionSuspensionStateDto.md)| **Note**: Unallowed properties are &#x60;processDefinitionId&#x60; and &#x60;processDefinitionKey&#x60;. | [optional] 
