...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobDefinitionQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.JobDefinitionQueryDtoSorting();
      });

      it('should create an instance of JobDefinitionQueryDtoSorting', function() {
        // TODO: update the code to test JobDefinitionQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.JobDefinitionQueryDtoSorting);
      });
