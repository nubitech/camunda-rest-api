...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricActivityInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricActivityInstanceQueryDtoSorting();
      });

      it('should create an instance of HistoricActivityInstanceQueryDtoSorting', function() {
        // TODO: update the code to test HistoricActivityInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricActivityInstanceQueryDtoSorting);
      });
