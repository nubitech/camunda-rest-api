...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricTaskInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricTaskInstanceQueryDtoSorting();
      });

      it('should create an instance of HistoricTaskInstanceQueryDtoSorting', function() {
        // TODO: update the code to test HistoricTaskInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricTaskInstanceQueryDtoSorting);
      });
