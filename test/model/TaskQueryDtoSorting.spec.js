...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.TaskQueryDtoSorting();
      });

      it('should create an instance of TaskQueryDtoSorting', function() {
        // TODO: update the code to test TaskQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.TaskQueryDtoSorting);
      });
