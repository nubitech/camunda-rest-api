...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AuthorizationUpdateDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.AuthorizationUpdateDto();
      });

      it('should create an instance of AuthorizationUpdateDto', function() {
        // TODO: update the code to test AuthorizationUpdateDto
        expect(instance).to.be.a(CamundaRestApi.AuthorizationUpdateDto);
      });
