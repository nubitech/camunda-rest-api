...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessDefinitionStatisticsResultDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ProcessDefinitionStatisticsResultDto();
      });

      it('should create an instance of ProcessDefinitionStatisticsResultDto', function() {
        // TODO: update the code to test ProcessDefinitionStatisticsResultDto
        expect(instance).to.be.a(CamundaRestApi.ProcessDefinitionStatisticsResultDto);
      });
