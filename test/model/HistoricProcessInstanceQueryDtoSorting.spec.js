...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricProcessInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricProcessInstanceQueryDtoSorting();
      });

      it('should create an instance of HistoricProcessInstanceQueryDtoSorting', function() {
        // TODO: update the code to test HistoricProcessInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricProcessInstanceQueryDtoSorting);
      });
