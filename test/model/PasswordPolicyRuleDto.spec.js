...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PasswordPolicyRuleDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.PasswordPolicyRuleDto();
      });

      it('should create an instance of PasswordPolicyRuleDto', function() {
        // TODO: update the code to test PasswordPolicyRuleDto
        expect(instance).to.be.a(CamundaRestApi.PasswordPolicyRuleDto);
      });
