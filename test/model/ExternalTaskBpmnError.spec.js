...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExternalTaskBpmnError', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ExternalTaskBpmnError();
      });

      it('should create an instance of ExternalTaskBpmnError', function() {
        // TODO: update the code to test ExternalTaskBpmnError
        expect(instance).to.be.a(CamundaRestApi.ExternalTaskBpmnError);
      });
