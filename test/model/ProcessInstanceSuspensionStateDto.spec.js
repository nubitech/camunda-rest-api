...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessInstanceSuspensionStateDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ProcessInstanceSuspensionStateDto();
      });

      it('should create an instance of ProcessInstanceSuspensionStateDto', function() {
        // TODO: update the code to test ProcessInstanceSuspensionStateDto
        expect(instance).to.be.a(CamundaRestApi.ProcessInstanceSuspensionStateDto);
      });
