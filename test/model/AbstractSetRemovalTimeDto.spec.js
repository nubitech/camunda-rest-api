...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AbstractSetRemovalTimeDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.AbstractSetRemovalTimeDto();
      });

      it('should create an instance of AbstractSetRemovalTimeDto', function() {
        // TODO: update the code to test AbstractSetRemovalTimeDto
        expect(instance).to.be.a(CamundaRestApi.AbstractSetRemovalTimeDto);
      });
