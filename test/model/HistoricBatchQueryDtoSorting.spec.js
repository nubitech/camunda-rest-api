...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricBatchQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricBatchQueryDtoSorting();
      });

      it('should create an instance of HistoricBatchQueryDtoSorting', function() {
        // TODO: update the code to test HistoricBatchQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricBatchQueryDtoSorting);
      });
