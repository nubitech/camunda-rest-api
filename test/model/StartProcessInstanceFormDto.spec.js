...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StartProcessInstanceFormDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.StartProcessInstanceFormDto();
      });

      it('should create an instance of StartProcessInstanceFormDto', function() {
        // TODO: update the code to test StartProcessInstanceFormDto
        expect(instance).to.be.a(CamundaRestApi.StartProcessInstanceFormDto);
      });
