...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricExternalTaskLogQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricExternalTaskLogQueryDtoSorting();
      });

      it('should create an instance of HistoricExternalTaskLogQueryDtoSorting', function() {
        // TODO: update the code to test HistoricExternalTaskLogQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricExternalTaskLogQueryDtoSorting);
      });
