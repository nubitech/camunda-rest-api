...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SetVariablesAsyncDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.SetVariablesAsyncDto();
      });

      it('should create an instance of SetVariablesAsyncDto', function() {
        // TODO: update the code to test SetVariablesAsyncDto
        expect(instance).to.be.a(CamundaRestApi.SetVariablesAsyncDto);
      });
