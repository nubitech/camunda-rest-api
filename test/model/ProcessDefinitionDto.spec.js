...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessDefinitionDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ProcessDefinitionDto();
      });

      it('should create an instance of ProcessDefinitionDto', function() {
        // TODO: update the code to test ProcessDefinitionDto
        expect(instance).to.be.a(CamundaRestApi.ProcessDefinitionDto);
      });
