...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SetRemovalTimeToHistoricBatchesDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.SetRemovalTimeToHistoricBatchesDto();
      });

      it('should create an instance of SetRemovalTimeToHistoricBatchesDto', function() {
        // TODO: update the code to test SetRemovalTimeToHistoricBatchesDto
        expect(instance).to.be.a(CamundaRestApi.SetRemovalTimeToHistoricBatchesDto);
      });
