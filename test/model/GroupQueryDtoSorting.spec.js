...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.GroupQueryDtoSorting();
      });

      it('should create an instance of GroupQueryDtoSorting', function() {
        // TODO: update the code to test GroupQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.GroupQueryDtoSorting);
      });
