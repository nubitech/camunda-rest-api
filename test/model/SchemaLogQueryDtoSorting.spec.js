...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SchemaLogQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.SchemaLogQueryDtoSorting();
      });

      it('should create an instance of SchemaLogQueryDtoSorting', function() {
        // TODO: update the code to test SchemaLogQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.SchemaLogQueryDtoSorting);
      });
