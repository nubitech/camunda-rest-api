...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LockedExternalTaskDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.LockedExternalTaskDto();
      });

      it('should create an instance of LockedExternalTaskDto', function() {
        // TODO: update the code to test LockedExternalTaskDto
        expect(instance).to.be.a(CamundaRestApi.LockedExternalTaskDto);
      });
