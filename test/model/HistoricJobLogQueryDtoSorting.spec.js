...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricJobLogQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricJobLogQueryDtoSorting();
      });

      it('should create an instance of HistoricJobLogQueryDtoSorting', function() {
        // TODO: update the code to test HistoricJobLogQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricJobLogQueryDtoSorting);
      });
