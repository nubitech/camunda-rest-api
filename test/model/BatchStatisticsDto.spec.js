...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchStatisticsDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.BatchStatisticsDto();
      });

      it('should create an instance of BatchStatisticsDto', function() {
        // TODO: update the code to test BatchStatisticsDto
        expect(instance).to.be.a(CamundaRestApi.BatchStatisticsDto);
      });
      ...
      it('should have the property jobsCreated (base name: "jobsCreated")', function() {
        // TODO: update the code to test the property jobsCreated
        expect(instance).to.have.property('jobsCreated');
        // expect(instance.jobsCreated).to.be(expectedValueLiteral);
      });
