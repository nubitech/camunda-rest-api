...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExternalTaskQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ExternalTaskQueryDtoSorting();
      });

      it('should create an instance of ExternalTaskQueryDtoSorting', function() {
        // TODO: update the code to test ExternalTaskQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.ExternalTaskQueryDtoSorting);
      });
