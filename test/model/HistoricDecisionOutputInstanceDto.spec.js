...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricDecisionOutputInstanceDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricDecisionOutputInstanceDto();
      });

      it('should create an instance of HistoricDecisionOutputInstanceDto', function() {
        // TODO: update the code to test HistoricDecisionOutputInstanceDto
        expect(instance).to.be.a(CamundaRestApi.HistoricDecisionOutputInstanceDto);
      });
      ...
      it('should have the property ruleOrder (base name: "ruleOrder")', function() {
        // TODO: update the code to test the property ruleOrder
        expect(instance).to.have.property('ruleOrder');
        // expect(instance.ruleOrder).to.be(expectedValueLiteral);
      });
