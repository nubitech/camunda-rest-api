...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessInstanceModificationDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ProcessInstanceModificationDto();
      });

      it('should create an instance of ProcessInstanceModificationDto', function() {
        // TODO: update the code to test ProcessInstanceModificationDto
        expect(instance).to.be.a(CamundaRestApi.ProcessInstanceModificationDto);
      });
