...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModificationDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ModificationDto();
      });

      it('should create an instance of ModificationDto', function() {
        // TODO: update the code to test ModificationDto
        expect(instance).to.be.a(CamundaRestApi.ModificationDto);
      });
