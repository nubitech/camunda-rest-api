...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MissingAuthorizationDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.MissingAuthorizationDto();
      });

      it('should create an instance of MissingAuthorizationDto', function() {
        // TODO: update the code to test MissingAuthorizationDto
        expect(instance).to.be.a(CamundaRestApi.MissingAuthorizationDto);
      });
