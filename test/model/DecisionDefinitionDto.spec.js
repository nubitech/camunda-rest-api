...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DecisionDefinitionDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.DecisionDefinitionDto();
      });

      it('should create an instance of DecisionDefinitionDto', function() {
        // TODO: update the code to test DecisionDefinitionDto
        expect(instance).to.be.a(CamundaRestApi.DecisionDefinitionDto);
      });
