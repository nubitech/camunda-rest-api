...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DurationReportResultDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.DurationReportResultDto();
      });

      it('should create an instance of DurationReportResultDto', function() {
        // TODO: update the code to test DurationReportResultDto
        expect(instance).to.be.a(CamundaRestApi.DurationReportResultDto);
      });
