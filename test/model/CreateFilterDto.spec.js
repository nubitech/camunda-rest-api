...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateFilterDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.CreateFilterDto();
      });

      it('should create an instance of CreateFilterDto', function() {
        // TODO: update the code to test CreateFilterDto
        expect(instance).to.be.a(CamundaRestApi.CreateFilterDto);
      });
