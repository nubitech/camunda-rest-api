...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricVariableInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricVariableInstanceQueryDtoSorting();
      });

      it('should create an instance of HistoricVariableInstanceQueryDtoSorting', function() {
        // TODO: update the code to test HistoricVariableInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.HistoricVariableInstanceQueryDtoSorting);
      });
