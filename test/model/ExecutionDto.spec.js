...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecutionDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ExecutionDto();
      });

      it('should create an instance of ExecutionDto', function() {
        // TODO: update the code to test ExecutionDto
        expect(instance).to.be.a(CamundaRestApi.ExecutionDto);
      });
