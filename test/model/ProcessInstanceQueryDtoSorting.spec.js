...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProcessInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ProcessInstanceQueryDtoSorting();
      });

      it('should create an instance of ProcessInstanceQueryDtoSorting', function() {
        // TODO: update the code to test ProcessInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.ProcessInstanceQueryDtoSorting);
      });
