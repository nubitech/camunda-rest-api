...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompleteTaskDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.CompleteTaskDto();
      });

      it('should create an instance of CompleteTaskDto', function() {
        // TODO: update the code to test CompleteTaskDto
        expect(instance).to.be.a(CamundaRestApi.CompleteTaskDto);
      });
