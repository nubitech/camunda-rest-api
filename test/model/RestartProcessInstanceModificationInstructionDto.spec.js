...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestartProcessInstanceModificationInstructionDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.RestartProcessInstanceModificationInstructionDto();
      });

      it('should create an instance of RestartProcessInstanceModificationInstructionDto', function() {
        // TODO: update the code to test RestartProcessInstanceModificationInstructionDto
        expect(instance).to.be.a(CamundaRestApi.RestartProcessInstanceModificationInstructionDto);
      });
