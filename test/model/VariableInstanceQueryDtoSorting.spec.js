...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VariableInstanceQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.VariableInstanceQueryDtoSorting();
      });

      it('should create an instance of VariableInstanceQueryDtoSorting', function() {
        // TODO: update the code to test VariableInstanceQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.VariableInstanceQueryDtoSorting);
      });
