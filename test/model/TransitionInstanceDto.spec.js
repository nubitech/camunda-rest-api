...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransitionInstanceDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.TransitionInstanceDto();
      });

      it('should create an instance of TransitionInstanceDto', function() {
        // TODO: update the code to test TransitionInstanceDto
        expect(instance).to.be.a(CamundaRestApi.TransitionInstanceDto);
      });
