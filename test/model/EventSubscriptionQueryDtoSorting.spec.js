...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventSubscriptionQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.EventSubscriptionQueryDtoSorting();
      });

      it('should create an instance of EventSubscriptionQueryDtoSorting', function() {
        // TODO: update the code to test EventSubscriptionQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.EventSubscriptionQueryDtoSorting);
      });
