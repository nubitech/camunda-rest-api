...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HistoricIdentityLinkLogDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.HistoricIdentityLinkLogDto();
      });

      it('should create an instance of HistoricIdentityLinkLogDto', function() {
        // TODO: update the code to test HistoricIdentityLinkLogDto
        expect(instance).to.be.a(CamundaRestApi.HistoricIdentityLinkLogDto);
      });
      ...
      it('should have the property assignerId (base name: "assignerId")', function() {
        // TODO: update the code to test the property assignerId
        expect(instance).to.have.property('assignerId');
        // expect(instance.assignerId).to.be(expectedValueLiteral);
      });
