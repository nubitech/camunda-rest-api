...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JobQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.JobQueryDtoSorting();
      });

      it('should create an instance of JobQueryDtoSorting', function() {
        // TODO: update the code to test JobQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.JobQueryDtoSorting);
      });
