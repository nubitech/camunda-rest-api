...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExtendLockOnExternalTaskDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ExtendLockOnExternalTaskDto();
      });

      it('should create an instance of ExtendLockOnExternalTaskDto', function() {
        // TODO: update the code to test ExtendLockOnExternalTaskDto
        expect(instance).to.be.a(CamundaRestApi.ExtendLockOnExternalTaskDto);
      });
