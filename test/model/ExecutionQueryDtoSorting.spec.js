...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ExecutionQueryDtoSorting', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.ExecutionQueryDtoSorting();
      });

      it('should create an instance of ExecutionQueryDtoSorting', function() {
        // TODO: update the code to test ExecutionQueryDtoSorting
        expect(instance).to.be.a(CamundaRestApi.ExecutionQueryDtoSorting);
      });
