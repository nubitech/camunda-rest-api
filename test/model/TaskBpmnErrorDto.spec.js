...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskBpmnErrorDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.TaskBpmnErrorDto();
      });

      it('should create an instance of TaskBpmnErrorDto', function() {
        // TODO: update the code to test TaskBpmnErrorDto
        expect(instance).to.be.a(CamundaRestApi.TaskBpmnErrorDto);
      });
