...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DecisionRequirementsDefinitionDto', function() {
      beforeEach(function() {
        instance = new CamundaRestApi.DecisionRequirementsDefinitionDto();
      });

      it('should create an instance of DecisionRequirementsDefinitionDto', function() {
        // TODO: update the code to test DecisionRequirementsDefinitionDto
        expect(instance).to.be.a(CamundaRestApi.DecisionRequirementsDefinitionDto);
      });
